...
exports.set = function(attrs, options){
  for (var key in attrs) {
    this[key](attrs[key], options);
  }
  return this;
};
...
exports.toJSON = function(){
  ...
  each(this.attrs, function (key, val) {
    json[key] = val.toJSON ? val.toJSON() : val;
  });
  return json;
};

/**
 * Parse the input to set attrs, defaults to pass through.
 * @param  {Object} attrs
 * @return {Object}       parsed attrs
 */
